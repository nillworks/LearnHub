...
import { recentTransactions } from "./admin-overview-data";
          ...
          {recentTransactions.map((tx, index) => (
            <div
              ...
              className={cn(
                ...
                index !== recentTransactions.length - 1 && "border-b border-border/50 dark:border-secondary/50"
              )}
            >
              ...
              <p className="text-sm font-bold font-heading text-primary-dark dark:text-primary shrink-0">
                ${tx.amount.toFixed(2)}
              </p>

              <span className="inline-flex items-center gap-1 px-2.5 py-1 text-[11px] font-bold font-body bg-primary-light dark:bg-primary-dark/20 text-primary-dark dark:text-primary rounded-full shrink-0">
