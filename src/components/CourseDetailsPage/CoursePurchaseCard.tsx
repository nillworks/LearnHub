...
import { Clock, Globe, BarChart, Smartphone, Award, RefreshCw, Heart, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className={cn("bg-white dark:bg-[#1e293b] rounded-3xl overflow-hidden shadow-sm border border-secondary-lighter dark:border-secondary sticky top-6", className)}>
      ...
      <div className="relative aspect-video w-full group cursor-pointer">
        <Image
          src={course.thumbnailUrl || "https://i.ibb.co/zVQqHs5k/Screenshot-2026-07-08-170200.png"}
      ...
      <div className="p-6">
        ...
        {/* Share Row */}
        <div>
          <p className="text-center text-text-secondary text-sm mb-3">Share this course:</p>
          <div className="flex items-center justify-center gap-3">
            ...
            <button className="w-10 h-10 rounded-full border border-secondary-lighter dark:border-secondary flex items-center justify-center text-text-secondary hover:text-primary hover:border-primary hover:bg-primary-light transition-colors">
              <svg className="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg>
            </button>
          </div>
        </div>
